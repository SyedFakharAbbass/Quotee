    ...
    <div className='mb-[60px] input' id="stylee">
      <div >
          ...
          <div className='flex flex-col gap-4 2xl:flex-row md:pt-[30px]'>
            ...
            <div className='flex items-center w-full gap-4 2xl:pt-[30px] '>
              ...
              <div className='bg-[#ECF8FD] h-[55px] items-center flex justify-center rounded-[10px] w-full  hov-inp'>
                ...
                <label for="bordered-checkbox-2" onClick={handleTear} className="cursor-pointer py-4  font-medium px-2  text-[#008bbf] text-[12px] md:text-[14px]">Tear Notch</label>
              </div>
            </div>
          </div>

          <div className='flex flex-col xl:flex-row gap-4 mt-[30px]'>
            <div className='w-full'>
              <div className='w-full'>
        ...
        <div>
          ...
          <div className='flex gap-4 new_class mt-[30px]'>
            <div className='w-full'>
              <div className=' w-full '>
          ...
          <div className='flex gap-4 new_class pt-5'>
            <div className=' w-full  '>
