            ...
            <form onSubmit={handleSubmit}>
                <div>
                    ...
                    <div className='flex justify-between new_class gap-[50px]'>
                        <div className='flex'>
                            <div className='flex gap-3 items-end  md:w-[518px]  justify-between '>
                                <div className=''>
                    ...
                    <div className='flex justify-between gap-[50px] new_class'>
                        <div className='flex md:w-[518px] mt-[30px]'>
                            <div className='  w-full'>
                ...
                <div className='mt-[-38px]'>
                    ...
                    <div className='flex mt-[30px] gap-[50px] new_class'>
                        <div className='  w-full'>
                        ...
                        <div className='flex items-center gap-4 w-full md:w-[381px] justify-between'>
                ...
                <div className='mt-[-38px]'>
                    ...
                    <div>
                        <textarea placeholder='Type.......' name="special_requirement" onChange={handleChange} value={formData.special_requirement} className='h-[300px] change_res w-[100%]  m-auto lg:w-full px-3 py-[20px] border-4 border-[#ECF8FD] rounded-[10px]' cols="30" rows="10"></textarea>
                    </div>
                </div>
