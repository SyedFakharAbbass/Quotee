                    ...
                    <div className='flex justify-between new_class'>
                        ...
                        <div className='flex items-center w-[381px] res_data justify-between'>
                            <div className='bg-[#ECF8FD] h-[55px] items-center flex justify-center rounded-[10px] w-[205px] pl-[8px] hov-inp'>
                                ...
                                <label for="bordered-checkbox-2" className="flex labled py-4 text-sm font-medium cursor-pointer px-2 text-[#008bbf] "><span onClick={handleIcons} className='text-[14px]'>Hang Hole</span>{showIcons && <div className='flex items-center'>{!checkedIcons ? <div className=''><img src="/images/img1.png" className='unckecked' alt="" onClick={handleCheck} /><span className='text-[10px]'>Euro</span></div> : <div><img src="/images/img2.png" className='ckecked' alt="" onClick={handleCheck} /><span className='text-[10px]'>Euro</span></div>} {!checkedIcons2 ? <div><img src="/images/img4.png" className='unckecked' alt="" onClick={handleCheck2} /><span className='text-[10px]'>Euro</span></div> : <div><img src="/images/img3.png" className='ckecked' alt="" onClick={handleCheck2} /><span className='text-[10px]'>Euro</span></div>} </div>}</label>
                            </div>
