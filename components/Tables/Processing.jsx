    ...
    return (
        <div className='mb-[60px] input' id="stylee">
            <form onSubmit={handleSubmit}>
                <div>
                    <h1 className='text-[rgb(0,139,191)] font-bold text-[18px] md:text-[26px] mt-16 mb-[30px] md:mb-[0px]'>JOB PROCESSING DATA</h1>
                    <div className='flex flex-col 2xl:flex-row gap-4 justify-between new_class'>
                        <div className='flex   '>
                            <div className='flex gap-3 items-end w-full  justify-between '>
                    ...
                    <div className='flex flex-col 2xl:flex-row 2xl:gap-[0px]  md:gap-[30px] mt-[30px]  new_class'>
                        <div className='  w-full  2xl:mr-[16px]'>
                            <div className='bg-[#ECF8FD]  rounded-[10px] hov-inp'>
                                <div className="flex items-center pl-4 " >
                                    ...
                                    <label for="bordered-checkbox-2" className="cursor-pointer py-4  font-medium px-4 text-[12px] md:text-[14px] text-[#008bbf] " onClick={handleZipper}>Child Resistant</label>
                        ...
                        <div className='flex items-center gap-4 w-full    justify-between mt-[30px]  md:mt-[0px] '>
                            <div className='bg-[#ECF8FD] h-[55px] items-center flex justify-center rounded-[10px] w-full  pl-[8px] hov-inp'>
                                ...
                                <label for="bordered-checkbox-2" className="flex labled py-4 text-sm font-medium cursor-pointer px-2 text-[#008bbf] "><span onClick={handleIcons} className='text-[12px] md:text-[14px]'>Hang Hole</span>{showIcons && <div className='flex items-center ml-[16px] mt-[10px]'>{!checkedIcons ? <div className='mr-[10px]'><img src="/images/img1.png" className='unckecked' alt="" onClick={handleCheck} /><span className='text-[10px]'>Round</span></div> : <div className='mr-[10px]'><img src="/images/img2.png" className='ckecked' alt="" onClick={handleCheck} /><span className='text-[10px]'>Round</span></div>} {!checkedIcons2 ? <div className=''><img src="/images/img4.png" className='unckecked' alt="" onClick={handleCheck2} /><span className='text-[10px]'>Euro</span></div> : <div className=''><img src="/images/img3.png" className='ckecked' alt="" onClick={handleCheck2} /><span className='text-[10px]'>Euro</span></div>} </div>}</label>
                            </div>
                ...
                <div className='mt-[-38px]'>
                    ...
                    <div>
                        <textarea placeholder='Type.......' name="special_requirement" onChange={handleChange} value={formData.special_requirement} className='h-[300px] text-area change_res w-[450px] lg:w-full px-3 py-[20px] border-4 border-[#ECF8FD] rounded-[10px]' cols="30" rows="10"></textarea>
                    </div>
                </div>
