      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <div>
            ...
            <div>
              <input name="email" value={formData.email} onChange={handleChange} className='bg-[#ECF8FD] w-[450px]  p-2 outline-none border-none hover:#008bbf rounded-[10px] h-[55px] set_div_new' type="text" />
            </div>
          ...
          <div className='pt-7'>
            ...
            <div>
              <input name="phone" value={formData.phone} onChange={handleChange} className='bg-[#ECF8FD] set_div_new w-[450px]   p-2 outline-none border-none hover:#008bbf rounded-[10px] h-[55px]' type="number" />
            </div>
