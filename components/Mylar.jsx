...
const Mylar = () => {
    return (
        <div>
            <div className='border-2 border-[#008BBF] w-[510px] h-[949px] rounded-[10px]'>
                <div>
                    <h2 className='text-[#008BBF] font-medium text-[22px] text-center pt-4'>Detail configuration about your selection:</h2>
                </div>
                <div className='flex pt-3'>
                    <div>
                        <img className='w-[280px] ' src="/images/lerbag.png" alt="" />
                    </div>
                    <div>
                        <p className='text-[#008BBF] font-medium pt-24 text-[30px]'>MyLar Bag</p>
                    </div>
                </div>
