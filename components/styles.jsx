    ...
    return (
        <div>
            {/* <div className='container'> */}
                ...
                {products === "one" && <div className="w-fit"> <h1 className='text-[#008bbf] font-bold text-[26px] mb-[30px]'>CHOOSE YOUR PRODUCT’S STYLE</h1><div className='flex mr-[27px] flex-wrap '>
                ...
                {products === "two" && <div className="w-fit"> <h1 className='text-[#008bbf] font-bold text-[26px] mb-[30px]'>CHOOSE YOUR PRODUCT’S STYLE</h1><div className='flex mr-[27px] flex-wrap '>
                ...
                {products === "three" && <div className="w-fit"> <h1 className='text-[#008bbf] font-bold text-[26px] mb-[30px]'>CHOOSE YOUR PRODUCT’S STYLE</h1><div className='flex mr-[27px] flex-wrap '>
