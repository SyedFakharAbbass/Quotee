    ...
    return (
        <div>
            {/* <div className='container'> */}
                ...
                {products === "one" && <div className=""> <h1 className='text-[#008bbf] font-bold text-[20px] md:text-[26px] mb-[20px] md:mb-[30px]'>CHOOSE YOUR PRODUCT’S STYLE</h1><div className='flex    flex-wrap items-center flex-col sm:flex-row gap-4 '>
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]  cursor-pointer rounded-[10px] ${styles === "style1" ? "selected" : ""}`} onClick={handleClick1}>
                    ...
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]  cursor-pointer rounded-[10px] ${styles === "style2" ? "selected" : ""}`} onClick={handleClick2}>
                    ...
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]  cursor-pointer rounded-[10px] ${styles === "style3" ? "selected" : ""}`} onClick={handleClick3}>
                ...
                {products === "two" && <div className=""> <h1 className='text-[#008bbf] font-bold text-[20px] md:text-[26px] mb-[20px]  md:mb-[30px]'>CHOOSE YOUR PRODUCT’S STYLE</h1><div className='flex flex-wrap items-center flex-col sm:flex-row gap-4 '>
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]   cursor-pointer rounded-[10px] ${styles === "style4" ? "selected" : ""}`} onClick={handleClick4}>
                    ...
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]   cursor-pointer rounded-[10px] ${styles === "style5" ? "selected" : ""}`} onClick={handleClick5}>
                    ...
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]   cursor-pointer rounded-[10px] ${styles === "style6" ? "selected" : ""}`} onClick={handleClick6}>
                ...
                {products === "three" && <div className=""> <h1 className='text-[#008bbf] font-bold text-[20px] md:text-[26px] mb-[20px] md:mb-[30px]'>CHOOSE YOUR PRODUCT’S STYLE</h1><div className='flex flex-wrap items-center flex-col sm:flex-row gap-4  '>
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]   cursor-pointer rounded-[10px] ${styles === "style7" ? "selected" : ""}`} onClick={handleClick7}>
                    ...
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]   cursor-pointer rounded-[10px] ${styles === "style8" ? "selected" : ""}`} onClick={handleClick8}>
                    ...
                    <div className={`w-[200px] h-[195px] bg-[#ECF8FD]   cursor-pointer rounded-[10px] ${styles === "style9" ? "selected" : ""}`} onClick={handleClick9}>
